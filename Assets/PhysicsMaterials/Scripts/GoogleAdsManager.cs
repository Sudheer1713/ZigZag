...
public class GoogleAdsManager : MonoBehaviour
{
    ...
    public UnityAction RewardEndEvent;
    ...
    void Start()
    {
        ...
        MobileAds.Initialize(initStatus =>
        {
            ...
            //LoadRewardedAd();
           // RewardEndEvent += () => GiveRewardedReward();
        });

    }

    public void GiveInterReward()
    {
        Debug.Log("Inter Ads Rewards Given");
    }

    public void GiveRewardedReward()
    {
        Debug.Log("Rewarded Ads Rewards Given");
...
public void DestroyBannerAd()
{
    ...
    public void ShowRewardedAd()
    {
        ...
        if (_rewardedAd != null && _rewardedAd.CanShowAd())
        {
            ...
            {
                if(RewardEndEvent !=null)
                    RewardEndEvent.Invoke();
